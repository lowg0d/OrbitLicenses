...
Following this go to "\OrbitLicense\bot\config" open config.json and change "token" to your aplication token and change the MySql data, you can also change any setting in the configuration.
